export default function Operator({data, onClick}) {
    ...
    return (
        <div key={data.id} onClick={() => onClick(data.id)} className="card flex flex-col cursor-pointer">
            <section className='flex flex-col items-center text-center rounded overflow-hidden'>
                <div className='relative flex flex-col items-center'>
                    ...
                    <img className='absolute bottom-2 w-1/2' src={path+"badges/"+data.badge} alt="Badge"/>
                </div>
